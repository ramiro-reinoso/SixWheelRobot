...
public class RightCrossLine extends AutonomousMode {
...
//		theRobot.shifter.set(false);
        ...
        trajPointsRight.addTrajectoryPoints("rw_traj_RightCrossLine_ticks.csv",1.0);
        trajPointsLeft = new ReadTrajectoryPoints();
        trajPointsLeft.addTrajectoryPoints("lw_traj_RightCrossLine_ticks.csv",1.0);
