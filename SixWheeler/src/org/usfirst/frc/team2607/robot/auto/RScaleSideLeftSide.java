...
public class RScaleSideLeftSide extends AutonomousMode {
	...
	public RScaleSideLeftSide (Robot r) {
		theRobot = r;
	}
	...
	public void startLoadingPoints () {
		...
		//theRobot.elevator.setPosition(19000);
...
//		theRobot.shifter.set(false);
        ...
        if(gameData.length() > 0)
        {
            if(gameData.charAt(1) == 'L')
            {
            	...
            	trajPointsRight.addTrajectoryPoints("rw_traj_RightScaleFailLeftFront_ticks.csv",1.0);
            	trajPointsLeft = new ReadTrajectoryPoints();
            	trajPointsLeft.addTrajectoryPoints("lw_traj_RightScaleFailLeftFront_ticks.csv",1.0);
            } else {
            	trajPointsRight = new ReadTrajectoryPoints();
            	trajPointsRight.addTrajectoryPoints("rw_traj_RightScaleSide_ticks.csv",1.0);
            	trajPointsLeft = new ReadTrajectoryPoints();
            	trajPointsLeft.addTrajectoryPoints("lw_traj_RightScaleSide_ticks.csv",1.0);
            }
        }
